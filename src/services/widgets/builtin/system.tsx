...
const specs: Spec[] = [
  ...
  {
    id: "system.openings-alert",
    name: "Offene Fenster & Türen",
    icon: "door-open",
    size: { w: 4, h: 2 },
    min: { w: 3, h: 2 },
    max: { w: 8, h: 3 },
    description: "Zeigt nur offene Fenster und Türen.",
    render: () => <W.OpeningsAlertWidget />,
  },
  {
    id: "system.low-battery",
    name: "Batterien niedrig",
    icon: "battery-warning",
    size: { w: 4, h: 2 },
    min: { w: 3, h: 2 },
    max: { w: 8, h: 3 },
    description: "Zeigt Geräte mit Batterie unter 20 Prozent.",
    render: () => <W.LowBatteryWidget />,
  },
  {
    id: "system.heating-control",
    name: "Heizung",
    icon: "flame",
    size: { w: 4, h: 2 },
    min: { w: 3, h: 2 },
    max: { w: 8, h: 3 },
    description: "Heizungen direkt vom Dashboard schalten.",
    render: () => <W.HeatingControlWidget />,
  },
  {
    id: "system.temperature-overview",
    name: "Temperaturen",
    icon: "thermometer",
    size: { w: 4, h: 2 },
    min: { w: 3, h: 2 },
    max: { w: 8, h: 4 },
    description: "Übersicht aller aktuellen Temperaturwerte.",
    render: () => <W.TemperatureOverviewWidget />,
  },
  {
    id: "system.climate-control",
    name: "Klima",
    icon: "wind",
    size: { w: 4, h: 2 },
    min: { w: 3, h: 2 },
    max: { w: 8, h: 3 },
    description: "Klimageräte direkt vom Dashboard schalten.",
